...
export default function Index(props) {
    ...
    const { data: ebooks, meta } = props.ebooks;
                                ...
                                <TableRow key={ebook.id}>
                                    ...
                                    <TableCell>
                                        <Avatar>
                                            ...
                                            />
                                            <AvatarFallback>
                                                {ebook.judul.substring(0, 1)?.toUpperCase() ?? '-'}
                                            </AvatarFallback>
                                        </Avatar>
                                    </TableCell>
                                    <TableCell>{ebook.created_at}</TableCell>
                                    <TableCell>
                                        <div className="flex items-center gap-x-1">
                                            <Button variant="blue" size="sm" asChild>
                                                <Link href={route('admin.ebooks.edit', [ebook])}>
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        <AlertDialogTitle>
                                                            Apakah anda yakin ingin menghapus e-book ini?
                                                        </AlertDialogTitle>
                                                        <AlertDialogDescription>
                                                            Tindakan ini tidak dapat dibatalkan. Semua data yang terkait
                                                            dengan e-book ini akan dihapus secara permanen.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        ...
                                                        <AlertDialogAction
                                                            onClick={() =>
                                                                router.delete(route('admin.ebooks.destroy', [ebook]))
                                                            }
                                                        >
                                                            Lanjutkan
                                                        </AlertDialogAction>
