...
export default function Index(props) {
    return(
        <div
        className="flex flex-col w-full pb-32 space-y-4">
            ...
            <div
            className="grid gap-4 md:grid-cols-2 lg:gap-8 lg:grid-cols-4">
                <CardStat
                data ={{ 
                        title: 'Harian',
                        icon: IconCalendar,
...
Index.layout = page => <AppLayout children={page} title={page.props.page_settings.title} subtitle={page.props.page_settings.subtitle} />
