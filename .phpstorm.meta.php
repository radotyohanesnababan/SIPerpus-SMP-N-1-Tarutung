...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\perpussmp1trt\public\storage' => 'string',
            ...
            'mail.mailers.mailtrap-sdk.transport' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\perpussmp1trt\\public\\storage',
...
'mail.mailers.roundrobin.mailers','mail.mailers.mailtrap-sdk.transport','mail.from.address','mail.from.name','mail.markdown.theme',
...
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','admin.loan-statistics.index','admin.book-stock-reports.index',
'admin.book-stock-reports.edit','admin.book-stock-reports.update','admin.categories.index','admin.categories.create','admin.categories.store',
'admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.publishers.index','admin.publishers.create',
'admin.publishers.store','admin.publishers.edit','admin.publishers.update','admin.publishers.destroy','admin.books.index',
'admin.books.create','admin.books.store','admin.books.edit','admin.books.update','admin.books.destroy',
'admin.users.index','admin.users.create','admin.users.store','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.borroweds.index','admin.borroweds.create','admin.borroweds.store','admin.borroweds.edit',
'admin.borroweds.update','admin.borroweds.destroy','admin.return-books.index','admin.return-books.create','admin.return-books.store',
'admin.return-books.destroy','admin.return-books.approve','admin.announcements.index','admin.announcements.create','admin.announcements.store',
'admin.announcements.edit','admin.announcements.update','admin.announcements.destroy','admin.roles.index','admin.roles.create',
'admin.roles.store','admin.roles.edit','admin.roles.update','admin.roles.destroy','admin.permissions.index',
'admin.permissions.create','admin.permissions.store','admin.permissions.edit','admin.permissions.update','admin.permissions.destroy',
'admin.assign-permissions.index','admin.assign-permissions.edit','admin.assign-permissions.update','admin.assign-users.index','admin.assign-users.edit',
'admin.assign-users.update','storage.local',);
