...
'view.paths','view.compiled','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist',
...
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','admin.categories.index','admin.categories.create',
'admin.categories.store','admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.publishers.index',
'admin.publishers.create','admin.publishers.store','admin.publishers.edit','admin.publishers.update','admin.publishers.destroy',
'admin.books.index','admin.books.create','admin.books.store','admin.books.edit','admin.books.update',
'admin.books.destroy','storage.local',);
